...
fetch('../json/htmlQuize.json')
  ...
  .then((loadhtmlQuestions) => {
    console.log(loadhtmlQuestions)
    htmlQuestions = loadhtmlQuestions
  })
...
next_btn.onclick = () => {
  if (que_count < htmlQuestions.length - 1) {
...
function showQuetions(index) {
  ...
  let que_tag =
    ...
    '. ' +
    htmlQuestions[index].question +
    '</span>'
  let option_tag =
    '<div class="option"><span>' +
    htmlQuestions[index].options[0] +
    '</span></div>' +
    '<div class="option"><span>' +
    htmlQuestions[index].options[1] +
    '</span></div>' +
    '<div class="option"><span>' +
    htmlQuestions[index].options[2] +
    '</span></div>' +
    '<div class="option"><span>' +
    htmlQuestions[index].options[3] +
    '</span></div>'
